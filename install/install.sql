...
INSERT INTO `yehnet_gd` VALUES (1,'thumb','头像缩图',75,75,'','middle-middle',50,0,80,0,'',0,'CD332C','',1,1,0),(3,'big','大图',600,600,'','bottom-right',70,2,80,0,'',0,'FFFFFF','',1,2,1),(2,'mid','项目标志',282,120,'','middle-middle',50,1,60,0,'',0,'CD332C','',1,2,0);
...
INSERT INTO `yehnet_input` VALUES ('text','zh','文本框',10,1),('radio','zh','单选框',20,1),('checkbox','zh','复选框',30,1),('textarea','zh','文本区域',40,1),('edit','zh','可视化编辑器',50,0),('select','zh','下拉菜单',60,1),('img','zh','图片选择器',70,1),('video','zh','影音选择器',80,1),('download','zh','下载框选择器',90,1),('opt','zh','联动选择',100,1),('simg','zh','图片选择器（单张）',75,1),('module','zh','内联模块',110,0);
...
INSERT INTO `yehnet_module_fields` VALUES (1,2,'content','内容',0,0,'','','edit','650px','400px','','',0,1,1,1,'请输入内容',1,0,'c',0,1,0),(2,3,'content','内容',0,0,'','','edit','650px','400px','','',0,2,0,1,'请输入内容',1,0,'c',0,1,0);
...
INSERT INTO `yehnet_module_group` VALUES (1,'zh','核心配置',1,4,'',1),(2,'zh','退出',1,7,'logout',1),(3,'zh','内容管理',1,1,'',1),(4,'zh','客户管理',1,3,'',1),(5,'zh','网站首页',1,6,'gohome',1),(6,'zh','房产合伙人',1,2,'',0),(7,'zh','清空缓存',1,5,'clear_cache',1);
...
INSERT INTO `yehnet_user_group` VALUES (1,'guest','游客','','','all',0,0,1,1),(2,'user','初级合伙人','','','all',1,0,1,1),(3,'user','金牌合伙人','','','',0,0,0,0);
